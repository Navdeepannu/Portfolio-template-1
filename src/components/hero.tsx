  ...
  return (
    <div className="h-[65vh] bg-gradient-to-b from-neutral-100 to-[#f4f4f4]">
      <div className="z-10 mx-auto flex h-[60vh] w-full max-w-7xl items-center px-6 md:px-6 lg:px-12">
        {/* Left Side - Content */}
        <div className="z-10 flex w-full flex-col items-start gap-5 md:w-1/2 md:gap-4 md:pr-8 lg:gap-5 lg:pr-20">
          {/* Main Heading */}
          <h1 className="font-times-heading text-text w-full text-left text-[34px] leading-[1.2] md:text-[32px] lg:text-[40px]">
            ...
            <Image
              ...
              src="/avatar.png"
              alt="Avatar"
              className="inline-block h-[38px] w-14 rounded-full border border-black object-cover shadow-md shadow-neutral-900 md:h-[36px] md:w-[52px] lg:h-[42px] lg:w-16"
            />
            <span>&nbsp;Navdeep</span>
            <br />
            ...
            <span className="inline-flex gap-2">
              <Image
                ...
                src="/dashboard.png"
                alt="Design"
                className="object-fit inline-block h-[38px] w-14 rounded-full border border-black shadow-md shadow-neutral-600 md:h-[36px] md:w-[52px] lg:h-[42px] lg:w-16"
              />
              <Image
                width={100}
                height={10}
          ...
          <div className="w-full max-w-lg">
            <p className="text-left text-[15px] leading-relaxed tracking-tight text-neutral-950/60 md:text-[14px] lg:text-[15px]">
